...
[heap 에 생성된 객체간 공유자원]static은 heap 에 생성된 객체간 공유하는 값
...
public class Ex04_Variable_Scope {
	...
	public static void main(String[] args) {
		...
		//vc.cv 힙메모리 가서 찾아보니 cv는 class영역에 있는 100을 참조
		System.out.println(vc.cv);
		vc.cv=5000;
		
		VariableClass vc2 = new VariableClass();
		System.out.println(vc2.cv); //공유자원이니까 5000
	}
